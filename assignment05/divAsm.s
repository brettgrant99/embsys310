/*******************************************************************************
File name       : divAsm.s
Description     : Assembly language function for Integer Halve (divide by 2)
*******************************************************************************/   

    EXTERN PrintString  // PrintString is defined outside this file.
    EXTERN divCstr       // myCstr defined outside this file.
...
Description     : Calls C code to print a string; 
                  computes the integer half of its input argument
...
divAsm
    ...
    LDR R0,=divCstr   // load (global) address of address of new half string into R0
    LDR R0,[R0]         // load address of string into R0
    BL  PrintString     // call PrintString to print the string
    POP {R0,LR}         // Restore R0 and LR
    MOV R1, #2          // put in the divisor
    UDIV R0, R0, R1     // R0 = R1 / R2 
